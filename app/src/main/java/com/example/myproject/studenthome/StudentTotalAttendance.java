...
public class StudentTotalAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_total_attendance);
        ...
        datebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        StudentTotalAttendance.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegisteredStudent registeredStudent=((ApplicationContext)StudentTotalAttendance.this.getApplicationContext()).getRegisteredStudent();

                attendanceSessionBean.setAttendance_session_registered_id(registeredStudent.getRegistered_id());
                ...
                ArrayList<Attendance> attendanceBeanList = databaseHelper.getTotalAttendanceBySessionID(attendanceSessionBean);
                ((ApplicationContext)StudentTotalAttendance.this.getApplicationContext()).setAttendanceBeanList(attendanceBeanList);

                Intent intent = new Intent(StudentTotalAttendance.this,ViewAttendanceByRegisteredActivity.class);
