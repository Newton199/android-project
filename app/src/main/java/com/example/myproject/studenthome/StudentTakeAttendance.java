    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        StudentTakeAttendance.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegisteredStudent registeredStudent =((ApplicationContext)StudentTakeAttendance.this.getApplicationContext()).getRegisteredStudent();
                ...
                attendanceSession.setAttendance_session_subject(subject);
                 ...
                 databaseHelper = new DatabaseHelper(StudentTakeAttendance.this);
                int sessionId=	databaseHelper.AddAttendanceSession(attendanceSession);
