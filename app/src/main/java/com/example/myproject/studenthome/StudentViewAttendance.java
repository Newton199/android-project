...
public class StudentViewAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelper(StudentViewAttendance.this);
        //department spinner
        ...
        datebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        StudentViewAttendance.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegisteredStudent registeredStudent=((ApplicationContext)StudentViewAttendance.this.getApplicationContext()).getRegisteredStudent();
                ...
                DatabaseHelper databaseHelper = new DatabaseHelper(StudentViewAttendance.this);

                ArrayList<Attendance> attendanceBeanList = databaseHelper.getAttendancebysessionid(attendanceSession);
                ((ApplicationContext)StudentViewAttendance.this.getApplicationContext()).setAttendanceBeanList(attendanceBeanList);

                Intent intent = new Intent(StudentViewAttendance.this,ViewAttendanceByRegisteredActivity.class);
